...
$categoria_id = test_input( $_POST['categoria_id'] ?? $producto['Categorias_idCategorias'] );
$promo = test_input( $_POST['promo'] ?? $producto['Promociones'] );
$dat = test_input( $_POST['descripcion'] ?? $producto['datos'] );
...
if( isset($_POST['submit']) )
{
    ...
    if( $imagen['error'] == '0' ){
        ...
        {
            array_push($errores, 'Usted debe cargar un archivo con formato  png o webp.');
        }
    ...
    if( count($errores) == 0 )
    {
       ...
       // $imagen_path = 'src/temp/'. $imagen['name'];
        ...
        move_uploaded_file( $imagen['tmp_name'], $imagen_path );   
       // $imagen_path = 'img/productos/' . $imagen['name'];
        }
        //move_uploaded_file( $imagen['tmp_name'], $imagen_path );
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4 w-100 h-100">
                        ...
                        <div class="card-body">
                            ...
                            <form class="m-3" method="post" action="actualizarprod.php" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="categoria_id" id="categoria_id">
                                        ...
                                        <?php foreach($categorias as $cat): ?>
                                            <option <?php if($cat['idCategorias'] == $categoria_id): ?> selected <?php endif ?> value="<?php echo $cat['idCategorias'] ?>"> <?php echo $cat['Nombre'] ?> </option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                                <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="promo" name="promo"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="descripcion" id="descripcion" cols="30" rows="10" placeholder="Ingrese la descripción del producto"><?php echo $dat ?></textarea>
                                </div>
                                <div class="mb-3">
