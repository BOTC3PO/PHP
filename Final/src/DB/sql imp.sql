...
-- -----------------------------------------------------
-- Table `mydb`.`Dias_permitidos_categorias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Dias_permitidos_categorias` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Dias_permitidos_categorias` (
  `dia` VARCHAR(8) NULL,
  `Categorias_idCategorias` INT NOT NULL,
  INDEX `fk_Dias_permitidos_copy1_Categorias1_idx` (`Categorias_idCategorias` ASC) ,
  CONSTRAINT `fk_Dias_permitidos_copy1_Categorias1`
    FOREIGN KEY (`Categorias_idCategorias`)
    REFERENCES `mydb`.`Categorias` (`idCategorias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`Dias_permitidos` (
  ...
  `dia` VARCHAR(8) NULL,
  INDEX `fk_Dias_permitidos_Productos_idx` (`Productos_id_Productos` ASC) ,
...
-- -----------------------------------------------------
-- Data for table `mydb`.`Dias_permitidos_categorias`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Dias_permitidos_categorias` (`dia`, `Categorias_idCategorias`) VALUES ('25-05', 9);
INSERT INTO `mydb`.`Dias_permitidos_categorias` (`dia`, `Categorias_idCategorias`) VALUES ('9-07', 9);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Dias_permitidos` (`Productos_id_Productos`, `dia`) VALUES (81, '25-05');
INSERT INTO `mydb`.`Dias_permitidos` (`Productos_id_Productos`, `dia`) VALUES (81, '9-07');
